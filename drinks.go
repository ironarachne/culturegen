...
func (culture Culture) generateDrinks() []Drink {
	...
	spices := climategen.ListResourcesOfType("spice", culture.HomeClimate.Resources)
	fruit := climategen.ListResourcesOfType("fruit", culture.HomeClimate.Resources)
	grain := climategen.ListResourcesOfType("grain", culture.HomeClimate.Resources)
